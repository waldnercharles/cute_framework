...
CF_INLINE SDL_GpuTextureFormat s_wrap(CF_PixelFormat format)
{
	...
	case CF_PIXEL_FORMAT_R8G8B8A8:             return SDL_GPU_TEXTUREFORMAT_R8G8B8A8_UNORM;
	case CF_PIXEL_FORMAT_B8G8R8A8:             return SDL_GPU_TEXTUREFORMAT_B8G8R8A8_UNORM;
	case CF_PIXEL_FORMAT_B5G6R5:               return SDL_GPU_TEXTUREFORMAT_B5G6R5_UNORM;
	case CF_PIXEL_FORMAT_B5G5R5A1:             return SDL_GPU_TEXTUREFORMAT_B5G5R5A1_UNORM;
	case CF_PIXEL_FORMAT_B4G4R4A4:             return SDL_GPU_TEXTUREFORMAT_B4G4R4A4_UNORM;
	case CF_PIXEL_FORMAT_R10G10B10A2:          return SDL_GPU_TEXTUREFORMAT_R10G10B10A2_UNORM;
	case CF_PIXEL_FORMAT_R16G16:               return SDL_GPU_TEXTUREFORMAT_R16G16_UNORM;
	case CF_PIXEL_FORMAT_R16G16B16A16:         return SDL_GPU_TEXTUREFORMAT_R16G16B16A16_UNORM;
	case CF_PIXEL_FORMAT_R8:                   return SDL_GPU_TEXTUREFORMAT_R8_UNORM;
	case CF_PIXEL_FORMAT_A8:                   return SDL_GPU_TEXTUREFORMAT_A8_UNORM;
	...
	case CF_PIXEL_FORMAT_BC1:                  return SDL_GPU_TEXTUREFORMAT_BC1_UNORM;
	case CF_PIXEL_FORMAT_BC2:                  return SDL_GPU_TEXTUREFORMAT_BC2_UNORM;
	case CF_PIXEL_FORMAT_BC3:                  return SDL_GPU_TEXTUREFORMAT_BC3_UNORM;
	case CF_PIXEL_FORMAT_BC7:                  return SDL_GPU_TEXTUREFORMAT_BC7_UNORM;
	...
	case CF_PIXEL_FORMAT_R16_SFLOAT:           return SDL_GPU_TEXTUREFORMAT_R16_FLOAT;
	case CF_PIXEL_FORMAT_R16G16_SFLOAT:        return SDL_GPU_TEXTUREFORMAT_R16G16_FLOAT;
	case CF_PIXEL_FORMAT_R16G16B16A16_SFLOAT:  return SDL_GPU_TEXTUREFORMAT_R16G16B16A16_FLOAT;
	case CF_PIXEL_FORMAT_R32_SFLOAT:           return SDL_GPU_TEXTUREFORMAT_R32_FLOAT;
	case CF_PIXEL_FORMAT_R32G32_SFLOAT:        return SDL_GPU_TEXTUREFORMAT_R32G32_FLOAT;
	case CF_PIXEL_FORMAT_R32G32B32A32_SFLOAT:  return SDL_GPU_TEXTUREFORMAT_R32G32B32A32_FLOAT;
	case CF_PIXEL_FORMAT_R8G8B8A8_SRGB:        return SDL_GPU_TEXTUREFORMAT_R8G8B8A8_UNORM_SRGB;
	case CF_PIXEL_FORMAT_B8G8R8A8_SRGB:        return SDL_GPU_TEXTUREFORMAT_B8G8R8A8_UNORM_SRGB;
	case CF_PIXEL_FORMAT_BC3_SRGB:             return SDL_GPU_TEXTUREFORMAT_BC3_UNORM_SRGB;
	case CF_PIXEL_FORMAT_BC7_SRGB:             return SDL_GPU_TEXTUREFORMAT_BC7_UNORM_SRGB;
	...
	case CF_PIXEL_FORMAT_D32_SFLOAT:           return SDL_GPU_TEXTUREFORMAT_D32_FLOAT;
	case CF_PIXEL_FORMAT_D24_UNORM_S8_UINT:    return SDL_GPU_TEXTUREFORMAT_D24_UNORM_S8_UINT;
	case CF_PIXEL_FORMAT_D32_SFLOAT_S8_UINT:   return SDL_GPU_TEXTUREFORMAT_D32_FLOAT_S8_UINT;
...
CF_INLINE SDL_GpuVertexElementFormat s_wrap(CF_VertexFormat format)
{
	...
	case CF_VERTEX_FORMAT_UBYTE4N: return SDL_GPU_VERTEXELEMENTFORMAT_UBYTE4_NORM;
	...
	case CF_VERTEX_FORMAT_SHORT2N: return SDL_GPU_VERTEXELEMENTFORMAT_SHORT2_NORM;
	case CF_VERTEX_FORMAT_SHORT4N: return SDL_GPU_VERTEXELEMENTFORMAT_SHORT4_NORM;
	case CF_VERTEX_FORMAT_HALFVECTOR2: return SDL_GPU_VERTEXELEMENTFORMAT_HALF2;
	case CF_VERTEX_FORMAT_HALFVECTOR4: return SDL_GPU_VERTEXELEMENTFORMAT_HALF4;
	}
}
